...
class Mnemonic {
   ...
   *
   * @apiExample Example usage:
   * xecjs.Mnemonic.validate('ca', xecjs.Mnemonic.wordLists().english)
   ...
   *
   * @apiExample Example usage:
   * await xecjs.Mnemonic.toSeed('enable stem left method one submit coach bid inspire cluster armed bracket')
